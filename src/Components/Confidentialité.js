...
const Confidentialité = () => {
  return (
    <div>
      <h1>Politique de Confidentialité — Nol Market </h1>
      <p>Dernière mise à jour : Novembre 2025 Chez Nol Market</p>
      <h4>
      ...
      <p>
        Vos données servent à : ✔ Traiter vos commandes et paiements ✔ Améliorer
        votre expérience utilisateur et nos services ✔ Gérer votre compte client
        ✔ Lutter contre la fraude et les usages abusifs ✔ Vous envoyer des
      ...
      <p>
        ...
        protégées par : Cryptage SSL/TLS Système anti-fraude Stockage
      ...
      <h2>Vos droits </h2>{" "}
      <p>
        Selon les lois en vigueur, vous avez le droit de : ✔ Accéder à vos
        données ✔ Rectifier ou mettre à jour vos informations ✔ Demander la
        suppression de votre compte ✔ Vous opposer au traitement de certaines
        données
      </p>{" "}
      Cette politique peut être modifiée pour respecter les obligations
      réglementaires ou améliorer notre service. La version en ligne est
      toujours la plus récente.{" "}
      <h4>Contact Pour toute question concernant cette politique :</h4>{" "}
      groupnolmarket@gmail.com Adresse : Cotonou, Fidjrossè
    </div>
  );
};

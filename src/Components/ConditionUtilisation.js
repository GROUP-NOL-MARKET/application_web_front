...
const ConditionUtilisation = () => {
  return (
    <div>
      <h2>Conditions d'Utilisation du Site — Nol Market</h2>
      ...
      <p>
        ...
        Vous vous engagez à fournir des informations :<ul></ul> ✔ Exactes ✔
        Complètes ✔ Mise à jour régulièrement Vous êtes responsable : de la
        confidentialité de vos identifiants de toutes les activités réalisées
        via votre compte Tout usage frauduleux doit être signalé immédiatement à
        : groupnolmarket@gmail.com
      </p>
      <h2>Utilisation Autorisée du Site</h2>
      <p>
        Vous vous engagez à utiliser le Site uniquement dans un cadre légal,
        notamment à ne pas : 🚫 Porter atteinte à l'ordre public 🚫 Détourner le
        Site de son usage commercial normal 🚫 Distribuer des virus ou scripts
        malveillants 🚫 Extraire, copier ou revendre le contenu du Site sans
        autorisation Nous nous réservons le droit de suspendre ou résilier un
      ...
      <p>
        ...
        détaillées dans nos Conditions Générales de Vente (CGV).{" "}
      </p>
      ...
      <h2>Avis et Contributions des Utilisateurs</h2>
      <p>
        {" "}

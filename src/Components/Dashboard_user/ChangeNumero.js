...
const ChangeNumero = ({ closePopUp2 }) => {
    ...
    useEffect(() => {
        const fetchUserData = async () => {
            try {
                ...
                // Reformate le numéro existant avec des espaces
                const formattedPhone = userPhone
                    ? userPhone.replace(/(\d{2})(?=\d)/g, "$1 ")
                    : "";
    ...
    const validate = () => {
        ...
        if (!cleanPhone.trim()) {
            ...
            if (secondPair < 50 || secondPair > 99) {
                newErrors.phone = "Les deux chiffres après '01' doivent être compris entre 20 et 29.";
            }
        }
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            toast.success(response.data.message || "Numéro de téléphone mis à jour avec succès !");
            closePopUp2();
        } catch (error) {
            ...
            <div className="popup rounded-3 p-3">
                ...
                <Form onSubmit={handleSubmit}>
                    <FormGroup className="m-2 text-center">
                        ...
                        <div className="row">
                            <div className="col-2" style={{ height: "45px" }}>
                                <CountryDropdown />
                            </div>

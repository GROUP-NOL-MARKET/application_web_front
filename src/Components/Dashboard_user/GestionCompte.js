...
const GestionCompte = () => {
  ...
  useEffect(() => {
    const isAnyPopupOpen =
      showPopUp1 || showPopUp2 || showPopUp3 || showPopUp4 || showPopUp5;
    ...
    <div>
      <div className="shadow-sm border border-1 p-2">
        ...
        <div className="container-fluid">
            ...
            <div className="col-lg-6 col-12 me-2 border border-1 shadow-sm p-2">
              <div className="row">
                <span className="col-2 me-1">
                  <img src={utilisateur} alt="" className="img-fluid" />
                </span>
          ...
          <div>
            <Button className="mt-3 w-100 rounded-5">
              <span className="petit_titre" onClick={openPopUp5}>
      ...
      {showPopUp1 && <InfosProfil closePopUp1={closePopUp1} />}
      {showPopUp2 && <ChangeNumero closePopUp2={closePopUp2} />}
      {showPopUp3 && <ModifierPassword closePopUp3={closePopUp3} />}
      {showPopUp4 && <Suppression closePopUp4={closePopUp4} />}
      {showPopUp5 && <Profile closePopUp5={closePopUp5} />}
    </div>
  );
};

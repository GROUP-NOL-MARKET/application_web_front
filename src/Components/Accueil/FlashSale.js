...
const FlashSale = ({ duration = 86400000 }) => {
                            ...
                            return {
                                ...
                                img:
                                    prod.image?.startsWith("http") ||
                                        prod.image?.startsWith("/storage/")
                                        ? prod.image
                                        : `http://127.0.0.1:8000/storage/${prod.image}`,
    ...
    return (
        <div className="container mt-4">
            ...
            <div className="enTête row">
                <h2 className="col-lg-2 col-3 title_flash_sale mt-2" style={{ color: "#0066BD" }}>
            ...
            {loading ? (
                ...
                <div className="text-center py-4" style={{ color: "#FA7F1B", fontWeight: "700" }}>
                            ...
                            {memoizedPromos.map((product) => (
                                <SwiperSlide key={product.id} className="product_slide">
                                    ...
                                    <div className="price_flash_sale">
                                        <span className="p-2 new_price">{product.new_price} FCFA</span>

            ...
            <div className="popup rounded-3">
                ...
                <div className="d-flex flex-column paiement_background">
                    ...
                    <div className="w-100 p-3 py-4">
                        <Form>
                            <FormLabel style={{ color: "#013A57" }} className="d-flex flex-column">
                                <h2 className="taux_moyen">Entrer votre numéro MTN de paiement</h2>
                                <p className="texte_brut">Un message sera envoyé sur ce numéro pour que vous confirmez le paiement.</p>
                            </FormLabel>

                            <div className="row">
                                <div className="col-4 col-sm-3 col-md-4 col-lg-2 me-2" style={{ pointerEvents: "none" }}>

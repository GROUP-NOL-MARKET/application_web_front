...
import { faHeart, faCartShopping, faArrowAltCircleRight } from "@fortawesome/free-solid-svg-icons";
...
const SearchProduct = () => {
    ...
    useEffect(() => {
        ...
        if (storedResults) {
            ...
            // fallback : si pas trouvé dans le localStorage, on recharge depuis l’API
